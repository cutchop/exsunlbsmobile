...
namespace GPSManager_Mobile
{
    public class OracleData : IDataBase
    {
        ...
        public OracleData(string source)
        {
            this._Connection = new OracleConnection(source);
        ...
        public bool ExecuteNonQuery(string[] sqls)
        {
            ...
            else
            {
                ...
                this._Connection.Open();
                //事务开始
                OracleTransaction transaction = this._Connection.BeginTransaction(IsolationLevel.ReadCommitted);
        ...
        public DataSet ExecuteReturnDataSet(string sql)
        {
            ...
            try
            {
                OracleDataAdapter adapter = new OracleDataAdapter(sql, this._Connection);
                adapter.Fill(ret);
                adapter.Dispose();
                adapter = null;
            }
